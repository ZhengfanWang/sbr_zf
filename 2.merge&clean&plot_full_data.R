...
i.miss7b <- which(is.na(SBR.full.ori$nSB) & 
                  is.na(SBR.full.ori$nTB) & 
                  is.na(SBR.full.ori$nLB) & 
                 !is.na(SBR.full.ori$SBR) & 
                       SBR.full.ori$SBR>0 & 
              !is.na(SBR.full.ori$WPP_LB) & SBR.full.ori$source %in% c("survey","admin"))
