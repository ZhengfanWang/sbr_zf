...
setwd("C:/Users/anmishra/Dropbox/UNICEF Stillbirth/Model/SBR 2020/Code/sbr_zf-master/def_adj")

hq.lmic.def.ori <- openxlsx::read.xlsx("C:/Users/anmishra/Dropbox/UNICEF Stillbirth/Model/SBR 2020/Code/sbr_zf-master/input/high quality LMIC study data/High Quality LMIC data_Definition.xlsx",sheet=1)
...
saveRDS(samp_22_lmic, "C:/Users/anmishra/Dropbox/UNICEF Stillbirth/Model/SBR 2020/defadj/output/samp_22_lmic.rds")

summary(samp_22_lmic)
pdf("C:/Users/anmishra/Dropbox/UNICEF Stillbirth/Model/SBR 2020/defadj/output/22wksLMICRplots.pdf")
plot(samp_22_lmic)
dev.off
#------------------------------------------------#
